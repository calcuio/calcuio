...
export function CharacterCounterTool() {
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea value={text} onChange={(e) => setText(e.target.value)} placeholder="Start typing or paste text…" className="input-base scrollbar-thin h-56 resize-y text-base" autoFocus />
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="card p-4 text-center"><p className="text-2xl font-bold text-brand-600 dark:text-brand-400">{stats.charsNoSpaces.toLocaleString()}</p><p className="mt-0.5 text-2xs font-medium uppercase tracking-wider text-slate-400">No spaces</p></div>
